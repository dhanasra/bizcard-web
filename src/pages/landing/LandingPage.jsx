      ...
      <Box className={classes.outerBox}>
        <Box className={classes.contentWrapper}>
          <Box className={`${classes.contentLeft} ${isSmallScreen? classes.contentMax: ''}`}>
            ...
            <Typography variant="body" color="#fff" sx={{marginTop: '32px', maxWidth: "70%", lineHeight: '1.8'}}>Loved by millions worldwide, HiHello helps everyone—from individuals to enterprises—turn each customer touchpoint into a branded, interactive, and measurable opportunity.</Typography>
            <div style={{marginTop: "32px"}}>
              <Button color="inverted" variant="contained" sx={{width: "180px"}} >Signup Now</Button>
              <Button color="white" variant="outlined" sx={{width: "180px", marginLeft: "16px"}} >Contact</Button>
            </div>
          </Box>
